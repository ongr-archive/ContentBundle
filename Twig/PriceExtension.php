...
class PriceExtension extends \Twig_Extension implements LoggerAwareInterface
{
    ...
    public function getPriceList(
        $environment,
        $price,
        $template = 'FoxUtilsBundle:Price:priceList.html.twig',
        $fromCurrency = null
    ) {
        $values = [];
     ...
     * @return string
     */
    public function getCurrencyList($environment, $template = 'FoxUtilsBundle:Price:currencyList.html.twig')
    {
        $values = [];
        foreach ($this->toListMap as $targetCurrency) {
            $values[] = [
     ...
     * @return string
     */
    public function getCurrencyListCss($environment, $template = 'FoxUtilsBundle:Price:currencyListCss.html.twig')
    {
        $values = [];
        foreach ($this->toListMap as $targetCurrency) {
            $values[] = [
