...
use ONGR\ContentBundle\Service\Currency\CurrencyExchangeService;
...
class PriceExtensionTest extends WebTestCase
{
     ...
     * @param string $base
     *
     * @return \PHPUnit_Framework_MockObject_MockObject|CurrencyRatesService
     */
    protected function getRatesService($rates, $base)
    {
        $mock = $this->getMockBuilder('ONGR\ContentBundle\Service\Currency\CurrencyRatesService')
    ...
    public function testGetFormattedPriceData()
    {
        ...
        // Case 5: base currency different than the one that we are converting from EUR to USD.
        $out[] = [
            '$ 1.334,50',
            1000.0,
            '',
        ...
        // Case 6: custom format to price from EUR to USD.
        $out[] = [
            '$ 1.334,50 $',
            1000.0,
            '',
    ...
    public function testPriceListFormattingData()
    {
        ...
        // PrintList currencies with all formats specified.
        $formatsMap = [
            'SEK' => '%s Svensk krona',
            'EUR' => '%s Euros',
        ];
        ...
        // PrintList currencies with one format specified.
        $formatsMap = [
            'SEK' => '%s Svensk krona',
        ];
        $expectedParams = [
    ...
    public function testPriceListWithCurrencyData()
    {
        ...
        // Currency not in the toPrintList is used.
        $expectedParams = [
            'currencies' => [
                [
                    'stringValue' => '74.93 ',
        ...
        // Currency in the toPrintList is used.
        $expectedParams = [
            'currencies' => [
                [
                    'stringValue' => '28.95 ',
